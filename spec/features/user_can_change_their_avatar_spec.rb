...
feature 'user can sign up for avatars', %Q{
  ...
  scenario 'user signs up' do
    ...
    click_on "Upload!"
    attach_file("Avatar", "#{Rails.root}/app/assets/images/banner.jpg")
    click_on "Upload!"

    expect(User.first.avatar.file.file).to eq("/Users/aly/Dropbox/professional/avatars/public/uploads/user/avatar/#{User.first.id}/banner.jpg")
  end
end
